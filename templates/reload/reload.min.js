...
var a;a=io.connect('http://'+window.location.host);a.on('connected',function(){return console.log('live reload connected')});a.on('reload',function(b){console.log('reloading...');if(b){return document.location.reload(true)}})