...
module.exports = function(cb){
  ...
  if (!fs.existsSync(path.join(process.cwd() + '/app.coffee'))) {
    ...
    options.exportDirectory = ".public"
    ...
    options.ignore_folders = options.ignore_folders.concat([global.options.exportDirectory, 'plugins'])
    ...
    options.watcher_ignore_folders = options.watcher_ignore_folders.concat(['components', global.options.exportDirectory, 'plugins', '.git'])
