...
client = keen.configure
  ...
  writeKey: 'd4dff32fa0e23516cf4828d2a71219255efd581f8ab3c1a0cc7081e8b1db62825f8
  3b0b5f9ec6417fd23fb877d082d1d5ce238ddc46d048b8ba6608557e87904a475f2a930e4903fc
  9872323fc120a4859dfb06919d9052e3b676e863a8f6332c21c5cb58be186457398780475dc62a
  5'
...
global.__track = (category, event) ->
  enabled ?= global_config().get('analytics')
  if enabled then client.addEvent(category, event)
