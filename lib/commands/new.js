...
var _new = function(commands){
  ...
  switch (commands[1]){
    case '--basic':
      var source = path.join(__dirname, '../../templates/new/basic');
      break;
    case '--express':
      var source = path.join(__dirname, '../../templates/new/express');
      break;
    case '--ejs':
      var source = path.join(__dirname, '../../templates/new/ejs');
      break;
    case '--blog':
      var source = path.join(__dirname, '../../templates/new/blog');
      break;
    case '--min':
      var source = path.join(__dirname, '../../templates/new/min');
      break;
    // case '--backbone':
    //   var source = path.join(__dirname, '../../templates/new_backbone');
    //   break;
    default:
      var source = path.join(__dirname, '../../templates/new/default');
  }
