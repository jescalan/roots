...
module.exports = function(cb){
  ...
  if (contents.match(/exports\./)) {
    var opts = global.options = require(config_path);
  } else {
    var opts = global.options = eval(coffee.compile(contents, { bare: true }));
  }
  ...
  opts.debug = opts.debug ? { status: opts.debug } : { status: false };
