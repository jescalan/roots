...
module.exports = function(args, cb){
  ...
  // temporary patch for swapping out axis
  opts.css_library = opts.css_library || 'axis-css';
  ...
  opts.ignore_folders = opts.ignore_folders.concat([roots.project.dirs['public'].slice(2), 'plugins']);
  ...
  opts.watcher_ignore_folders = opts.watcher_ignore_folders.concat(['components', 'plugins', '.git', roots.project.dirs['public'].slice(2)]);
